...
package io.lavagna.ext.model.apihook;

import io.lavagna.ext.model.BoardColumn;
import io.lavagna.ext.model.CardDataHistory;
...
public class From {
    ...
    public static User from(io.lavagna.ext.model.User user) {
    ...
    public static CardData from(io.lavagna.ext.model.CardData data) {
